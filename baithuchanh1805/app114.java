...
public class App114 {
  public static void main(String[] args){
    ...
    hashMap.put("1", new Student("2021050381", "Nguyen Thi Lien", "E2"));
    hashMap.put("2", new Student("2021050383", "Nguyen Thi Lien", "E1"));
    hashMap.put("3", new Student("2021050384", "Pham Thi Lien", "E1"));
    hashMap.put("4", new Student("2021050386", "Dinh Thi Linh", "E2"));
